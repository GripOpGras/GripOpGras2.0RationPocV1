...
Scenario: Create a ration for a herd, when having three roughage products
	...
	And the ration must contain <grass-intake> kg of grass
Examples: 
| roaghage1 | dm-roaghage1 | re-roaghage1 | vem-roaghage1 | roaghage2 | dm-roaghage2 | re-roaghage2 | vem-roaghage2 | roaghage3 | dm-roaghage3 | re-roaghage3 | vem-roaghage3 | herd-size | grass-intake | vem-grass | protein-grass | lmilk-produced | kg-roaghage1 | kg-roaghage2 | kg-roaghage3 |
